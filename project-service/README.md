...
🔐 **Authorization Logic**
--------------------------
Only users with the Manager role are allowed to create projects
All project-related operations are protected using JWT verification
Role-based access ensures proper permission handling
...
--------------------------------
This service depends on the Auth Service for:
Token generation
User authentication
